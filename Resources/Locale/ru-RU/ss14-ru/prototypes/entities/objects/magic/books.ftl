...
ent-WizardsGrimoire = гримуар волшебника
    .desc = Тяжёлый том, содержащий сложные тайные формулы для подготовки магических заклинаний и вызова сверхъестественного снаряжения. Десятилетия исследований ушли на изучение этой коллекции мистических секретов; теперь идите и используйте их, чтобы испортить кому-то день.
    .suffix = Волшебник
...
ent-WizardsGrimoireDebug = { ent-WizardsGrimoire }
    .desc = Тяжёлый том, содержащий сложные тайные формулы для подготовки магических заклинаний и вызова сверхъестественного снаряжения. Кто-то написал «ТОЛЬКО ДЛЯ ЭКСПЕРИМЕНТАЛЬНОГО ИСПОЛЬЗОВАНИЯ» на внутренней стороне обложки.
