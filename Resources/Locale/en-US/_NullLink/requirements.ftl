...
roles-req-lunarix-owner = Lunarix (Owner)
roles-req-lunarix-curator = curator
roles-req-lunarix-dev = developer
roles-req-lunarix-mod = moderator
roles-req-lunarix-mapping = mapper
roles-req-lunarix-creative = creative department
roles-req-lunarix-staff = project team
