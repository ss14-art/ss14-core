...
public sealed partial class NullLinkCCVars
{
    ...
    public static readonly CVarDef<string> TitleBuild =
        CVarDef.Create("nulllink.roles_req.title_builder", "Lunarix", CVar.SERVER | CVar.REPLICATED);
    ...
    public static readonly CVarDef<string> AdminRankBuilder =
        CVarDef.Create("nulllink.roles_req.admin_builder", "Lunarix", CVar.SERVER);
}
